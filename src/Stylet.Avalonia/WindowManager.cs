...
namespace Stylet.Avalonia
{
    ...
    public class WindowManager : IWindowManager
    {
        ...
        public bool? ShowDialog(object viewModel, IViewAware ownerViewModel)
        {
            ...
            return this.CreateWindow(viewModel, true, ownerViewModel).ShowDialog<bool>(window).Result;
        }
        ...
        protected virtual Window CreateWindow(object viewModel, bool isDialog, IViewAware ownerViewModel)
        {
            ...
            if (haveDisplayName != null && (String.IsNullOrEmpty(window.Title) || window.Title == view.GetType().Name)
            ...
            if (window.WindowStartupLocation == WindowStartupLocation.Manual
                && Double.IsNaN(window.Bounds.Top)
                && Double.IsNaN(window.Bounds.Left)
        ...
        private class WindowConductor : IChildDelegate
        {
            ...
            public WindowConductor(Window window, object viewModel)
            {
                ...
                {
                    window.PlatformImpl.WindowStateChanged += this.WindowStateChanged;
            ...
            private void WindowStateChanged(WindowState e)
            {
                switch (e)
                {
            ...
            private void WindowClosed(object sender, EventArgs e)
            {
                ...
                this.window.PlatformImpl.WindowStateChanged -= this.WindowStateChanged;
