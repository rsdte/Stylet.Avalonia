...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        void IViewAware.AttachView(Control view)
        {
            ...
            {
                if (viewAsFrameworkElement.IsInitialized)
                    this.OnViewLoaded();
                else
                    viewAsFrameworkElement.Initialized += (o, e) => this.OnViewLoaded();
            }
        }
        ...
        Control IViewAware.View => throw new NotImplementedException();
